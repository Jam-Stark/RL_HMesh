...
#include <string>
#include <ctime>
#include "TopoHexMeshLib_sheet_singularity/src/tools.h"
#include "TopoHexMeshLib_sheet_singularity/src/meshQuality.h"
#include "TopoHexMeshLib_sheet_singularity/src/sheet_operation.h"
#include "TopoHexMeshLib_sheet_singularity/src/singularity_number.h"
#include "TopoHexMeshLib_sheet_singularity/src/topoMesh.h"
...
bool play_action(int action, bool done, State& state, TMesh& tmesh, sheet_operation<TMesh>& sheet_op, get_singularity_number<TMesh>& get_singularity_num_op);
